...
function getFilterTag(formObj) {
  ...
  if(typeof url != 'undefined' && url != formObj['default_url'].value) {
    miscAttribs += '|url=' + url;
  }
  miscAttribs = encodeURIComponent(miscAttribs);
  var content = '<img src="' + Drupal.settings.basePath + 'index.php?q=img_assist/view/' + nid + '"'
