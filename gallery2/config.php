 ...
 */
$gallery->setConfig('setup.password', '4WiuHhMkSs');
 ...
 */
$gallery->setConfig('data.gallery.base', '/var/www/dr-files/g2data/');
...
$storeConfig['hostname'] = 'mysql33749-env-0509183.jelastic.planeetta.net';
$storeConfig['database'] = 'kesannon';
$storeConfig['username'] = 'kesannon';
$storeConfig['password'] = 'xWpPMJjythXxHHaf';
